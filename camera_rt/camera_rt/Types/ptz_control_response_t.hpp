...
#ifndef __ptz_camera_ptz_control_response_t_hpp__
#define __ptz_camera_ptz_control_response_t_hpp__
...
class ptz_control_response_t
{
    ...
    public:
        ...
        /**
         * Returns "ptz_control_response_t"
         */
...
int ptz_control_response_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ptz_control_response_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int ptz_control_response_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t ptz_control_response_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* ptz_control_response_t::getTypeName()
{
    return "ptz_control_response_t";
}

int ptz_control_response_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ptz_control_response_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int ptz_control_response_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t ptz_control_response_t::_computeHash(const __lcm_hash_ptr *)
{
