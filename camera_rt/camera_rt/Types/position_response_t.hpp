...
#ifndef __ptz_camera_position_response_t_hpp__
#define __ptz_camera_position_response_t_hpp__
...
int position_response_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int position_response_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int position_response_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t position_response_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* position_response_t::getTypeName()
{
    return "position_response_t";
}

int position_response_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int position_response_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int position_response_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
{
    uint64_t hash = 0x7f6ca048f2a83c49LL;
